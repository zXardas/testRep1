...
public void testCase1() {
    ...
    public void testCase5() {
        driver.get(URLMAIL);
        List<WebElement> elements = driver.findElements(By.xpath("//div[@data-testid='news-tabs']")); // получаю элементы меню
        List<String> menuElementss = new ArrayList<>(Arrays.asList("Новости","Спорт","Леди","Авто","Кино","Hi-Tech","Игры","Дети","Здоровье","Дом","Питомцы")); //их названия
        String menuElements = "Новости"+"\n"+"Спорт"+"\n"+"Леди"+"\n"+"Авто"+"\n"+"Кино"+"\n"+"Hi-Tech"+"\n"+"Игры"+"\n"+"Дети"+"\n"+"Здоровье"+"\n"+"Дом"+"\n"+"Питомцы";

        for (WebElement el:elements){
            Assertions.assertEquals(el.getText(),menuElements);
            Assertions.assertEquals(el.getText().length(),menuElements.length());
        }
    }
